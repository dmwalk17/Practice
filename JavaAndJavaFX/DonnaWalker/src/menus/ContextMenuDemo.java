...
public class ContextMenuDemo extends Application {   
  ...
  public void start(Stage primaryStage) {   
    ...
    MenuItem menuItemNew = new MenuItem("New",
      new ImageView("http://www.cs.armstrong.edu/liang/image/new.gif"));
    MenuItem menuItemOpen = new MenuItem("Open",
      new ImageView("http://www.cs.armstrong.edu/liang/image/open.gif"));
    MenuItem menuItemPrint = new MenuItem("Print",
      new ImageView("http://www.cs.armstrong.edu/liang/image/print.gif"));
